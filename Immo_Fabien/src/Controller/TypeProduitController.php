...
class TypeProduitController extends AbstractController
{
    ...
    public function new(Request $request): Response
    {
        ...
        return $this->render('admin/typeProduit/new.html.twig', [
    ...
    {
        return $this->render('admin/typeProduit/show.html.twig', [
            'type_produit' => $typeProduit,
        ]);
    }
    ...
    public function edit(Request $request, TypeProduit $typeProduit): Response
    {
        ...
        return $this->render('admin/typeProduit/edit.html.twig', [
            'type_produit' => $typeProduit,
            'form' => $form->createView(),
        ]);
    }
